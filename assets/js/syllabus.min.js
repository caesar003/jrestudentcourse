$(document).ready(function(){
  ...
  function show_syllabus(pin,prg) {
    $.ajax({
      type: 'post',
      url: `${siteurl}/syllabus/get_syllabus`,
      dataType: 'json',
  ...
  $('#show_syllabus').on('click', '.topic_check', function(){
    ...
    if(ind==0){
      $.ajax({
        type : "post",
        url : `${siteurl}/syllabus/check_topic`,
        dataType : "json",
      ...
      $.ajax({
        type: "POST",
        url : `${siteurl}/syllabus/check_ind`,
        dataType : "JSON",
        data : {pin : pin, id : id, status: status},
        success : function(data){
          $.ajax({
            type : "post",
            url : `${siteurl}/syllabus/get_this_topic`,
            dataType : "json",
            ...
            success : function(data){
              if(data.length==0){
                $.ajax({
                  ...
                  $.ajax({
                    type : "post",
                    url : `${siteurl}/syllabus/check_topic_header`,
                    dataType : "json",
  ...
  function assign_section(pin, section, assign, program){
    $.ajax({
      url: `${siteurl}/syllabus/assign_section`,
      type : "post",
      dataType : "json",
  ...
  function assign_topic(pin, section, topic, assign, program){
    $.ajax({
      url: `${siteurl}/syllabus/assign_topic`,
      type : "post",
      dataType : "json",
  ...
  function assign_indicator(pin, id, assign, program){
    $.ajax({
      url: `${siteurl}/syllabus/assign_indicator`,
      type : "post",
      dataType : "json",
  ...
  $('#show_syllabus').on('click','.syllabus-level', function(){
    ...
    $.ajax({
      url : `${siteurl}/syllabus/get_sections`,
      type : "post",
      dataType : "json",
      data : {level:level},
      success : function(data){
  ...
  $('#show_syllabus').on('click', '.syllabus_section', function(){
    ...
    var level = $(this).data('level'),
        section = $(this).data('section');
    $.ajax({
      url:`${siteurl}/syllabus/get_topics`,
      type : "post",
      dataType : "json",
  ...
  function create_syllabus(level){
    $.ajax({
      type : "post",
      url : `${siteurl}/syllabus/create`,
      dataType : "json",
      data : {pin:pin},
      success:function(data){
        $.ajax({
          type : "post",
          url : `${siteurl}/syllabus/insert`,
          dataType : "json",
  ...
  function set_program(pin,level){
    $.ajax({
      url:`${siteurl}/syllabus/set_program`,
      type : "post",
      dataType : "json",
      data : {pin:pin,level:level},
      success : function(data){
