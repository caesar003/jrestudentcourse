$(document).ready(function(){
  ...
  function get_schedules(){
    ...
    $.ajax({
      type : "ajax",
      url : `${siteurl}/schedule/get_schedules`,
      dataType : "JSON",
  ...
  $('#add_schedule').on('click', function(){
    ...
    if(d==''){
      ...
      $.ajax({
        type : "POST",
        url : `${siteurl}/schedule/date_availability`,
        data : {d:d},
        success : function(response){
          if (response == 'true'){
            ...
            $.ajax({
              type: "POST",
              url : `${siteurl}/schedule/add_schedule`,
              dataType : "JSON",
              data : {d:d},
              success : function(data){
                $.ajax({
                  type : "POST",
                  url : `${siteurl}/schedule/create_schedule`,
                  dataType : "JSON",
                  data: {d:d},
                  success: function(data){
                    $.ajax({
                      type : "POST",
                      url : `${siteurl}/schedule/insert_teachers`,
                      dataType : "JSON",
                      data: {d:d},
                      success: function(data){
                        get_schedule();
  ...
  function get_schedule(d = $('#schedule_date').val()){
    ...
    $.ajax({
      type: "ajax",
      url: `${siteurl}/schedule/get_schedule?d=${d}`,
      dataType : "JSON",
      success : function(data){
        var html = '',
...
<td><a data-id="${data[i].id}" class="btn-sm teacher_delete" href="javascript:void(0);"><i style="color:red;" class="fas fa-trash"></i></a></td>
  ...
  $('#note').on('focusout',function(){
    ...
    if (str != str2){
      $.ajax({
        type : "post",
        url : `${siteurl}/schedule/update_note`,
        dataType : "json",
        data : {d:d, str:str2},
        success :function(data){
          get_schedule();
  ...
  $('#add_teacher').on('submit', function(e){
    ...
    if (name == ''){
      ...
      $.ajax({
        url: `${siteurl}/schedule/add_teacher`,
        method : "POST",
        dataType : "JSON",
        data : {name : name, d: d},
        success : function(data){
  ...
  $('#btn_delete_teacher').on('click', function(){
    ...
    $.ajax({
      type : "POST",
      url : `${siteurl}/schedule/delete_teacher`,
      dataType : "JSON",
      data : {id:id, d:d},
      success: function(data){
